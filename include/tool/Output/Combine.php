...
class Combine{
	...
	public static $scripts = array(
			...
			'ui-theme'	=> array(
									...
									'package'		=> 'jquery_ui',
									'cdn'			=> array(
														'CloudFlare'	=> '//cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.4/themes/smoothness/jquery-ui.min.css',
														'Google'		=> '//ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/themes/smoothness/jquery-ui.min.css',
														),
									),
			...
			'ui-core'	=> array(
									...
									'label'			=> 'jQuery UI',
									'cdn'			=> array(
														'CloudFlare'	=> '//cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js',
														'Google'		=> '//ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js',
														),
									),
			...
			'colorbox'	=> array(
									...
									'label'			=> 'Colorbox JS',
									'cdn'			=> array(
														'CloudFlare'	=> '//cdnjs.cloudflare.com/ajax/libs/jquery.colorbox/1.6.4/jquery.colorbox-min.js',
														),
									),
